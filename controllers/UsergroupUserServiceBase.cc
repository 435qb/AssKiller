...
void UsergroupUserServiceBase::getOne(const HttpRequestPtr &req,
                                      std::function<void(const HttpResponsePtr &)> &&callback,
                                      UsergroupUser::PrimaryKeyType &&id)
{
    ...
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](UsergroupUser r) {
...
void UsergroupUserServiceBase::updateOne(const HttpRequestPtr &req,
                                         std::function<void(const HttpResponsePtr &)> &&callback,
                                         UsergroupUser::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!UsergroupUser::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!UsergroupUser::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void UsergroupUserServiceBase::deleteOne(const HttpRequestPtr &req,
                                         std::function<void(const HttpResponsePtr &)> &&callback,
                                         UsergroupUser::PrimaryKeyType &&id)
{
