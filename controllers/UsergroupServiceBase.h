 ...
 * this class is a restful API controller for reading and writing the usergroup table.
 */

class UsergroupServiceBase : public RestfulController
{
  public:
