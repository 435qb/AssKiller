 ...
 * this class is a restful API controller for reading and writing the transactions table.
 */

class TransactionsServiceBase : public RestfulController
{
  public:
