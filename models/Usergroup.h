...
class Usergroup
{
  public:
     ...
     */
    explicit Usergroup(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Usergroup(const Json::Value &pJson) noexcept(false);
     ...
     */
    Usergroup(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column nextuuid  */
    ///Get the value of the column nextuuid, returns the default value if the column is null
    const std::string &getValueOfNextuuid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getNextuuid() const noexcept;
    ///Set the value of the column nextuuid
    void setNextuuid(const std::string &pNextuuid) noexcept;
    void setNextuuid(std::string &&pNextuuid) noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Usergroup, true, false>;
    friend drogon::orm::BaseBuilder<Usergroup, false, true>;
    friend drogon::orm::BaseBuilder<Usergroup, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Usergroup>;
#endif
