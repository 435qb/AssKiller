...
class Confirm
{
  public:
     ...
     */
    explicit Confirm(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Confirm(const Json::Value &pJson) noexcept(false);
     ...
     */
    Confirm(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Confirm, true, false>;
    friend drogon::orm::BaseBuilder<Confirm, false, true>;
    friend drogon::orm::BaseBuilder<Confirm, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Confirm>;
#endif
